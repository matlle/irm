...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Dec 9 22:09:54 2014
# Project:  irm.pro
# Template: app
...
SOURCES       = sources/main.cpp \
		sources/Window.cpp \
		sources/pages.cpp moc_Window.cpp
OBJECTS       = main.o \
		Window.o \
		pages.o \
		moc_Window.o
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/irm1.0.0 || $(MKDIR) .tmp/irm1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/irm1.0.0/ && $(COPY_FILE) --parents headers/Window.h headers/pages.h .tmp/irm1.0.0/ && $(COPY_FILE) --parents sources/main.cpp sources/Window.cpp sources/pages.cpp .tmp/irm1.0.0/ && (cd `dirname .tmp/irm1.0.0` && $(TAR) irm1.0.0.tar irm1.0.0 && $(COMPRESS) irm1.0.0.tar) && $(MOVE) `dirname .tmp/irm1.0.0`/irm1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/irm1.0.0
