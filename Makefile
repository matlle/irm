...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sun Jan 4 12:32:29 2015
# Project:  irm.pro
# Template: app
...
SOURCES       = sources/main.cpp \
		...
		sources/ResidentDialog.cpp moc_Window.cpp \
		moc_pages.cpp
OBJECTS       = main.o \
		Window.o \
		pages.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/irm0.1.0/ && $(COPY_FILE) --parents headers/Window.h headers/pages.h headers/DBFactory.h headers/ResidentDialog.h .tmp/irm0.1.0/ && $(COPY_FILE) --parents sources/main.cpp sources/Window.cpp sources/pages.cpp sources/DBFactory.cpp sources/ResidentDialog.cpp .tmp/irm0.1.0/ && (cd `dirname .tmp/irm0.1.0` && $(TAR) irm0.1.0.tar irm0.1.0 && $(COMPRESS) irm0.1.0.tar) && $(MOVE) `dirname .tmp/irm0.1.0`/irm0.1.0.tar.gz . && $(DEL_FILE) -r .tmp/irm0.1.0
...
compiler_moc_header_make_all: moc_Window.cpp moc_pages.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Window.cpp moc_pages.cpp
