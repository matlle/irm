...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Mon Jan 5 01:00:19 2015
# Project:  irm.pro
# Template: app
...
SOURCES       = sources/main.cpp \
		...
		sources/photopreview.cpp moc_Window.cpp \
		moc_pages.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/irm0.1.0/ && $(COPY_FILE) --parents headers/Window.h headers/pages.h headers/DBFactory.h headers/ResidentDialog.h headers/common.h headers/photopreview.h .tmp/irm0.1.0/ && $(COPY_FILE) --parents sources/main.cpp sources/Window.cpp sources/pages.cpp sources/DBFactory.cpp sources/ResidentDialog.cpp sources/photopreview.cpp .tmp/irm0.1.0/ && (cd `dirname .tmp/irm0.1.0` && $(TAR) irm0.1.0.tar irm0.1.0 && $(COMPRESS) irm0.1.0.tar) && $(MOVE) `dirname .tmp/irm0.1.0`/irm0.1.0.tar.gz . && $(DEL_FILE) -r .tmp/irm0.1.0
...
compiler_moc_header_make_all: moc_Window.cpp moc_pages.cpp moc_ResidentDialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Window.cpp moc_pages.cpp moc_ResidentDialog.cpp
