...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Fri Dec 12 23:19:25 2014
# Project:  irm.pro
# Template: app
...
SOURCES       = sources/main.cpp \
		sources/Window.cpp \
		sources/pages.cpp \
		sources/DBFactory.cpp moc_Window.cpp
OBJECTS       = main.o \
		Window.o \
		pages.o \
		DBFactory.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/irm0.1.0/ && $(COPY_FILE) --parents headers/Window.h headers/pages.h headers/DBFactory.h .tmp/irm0.1.0/ && $(COPY_FILE) --parents sources/main.cpp sources/Window.cpp sources/pages.cpp sources/DBFactory.cpp .tmp/irm0.1.0/ && (cd `dirname .tmp/irm0.1.0` && $(TAR) irm0.1.0.tar irm0.1.0 && $(COMPRESS) irm0.1.0.tar) && $(MOVE) `dirname .tmp/irm0.1.0`/irm0.1.0.tar.gz . && $(DEL_FILE) -r .tmp/irm0.1.0
